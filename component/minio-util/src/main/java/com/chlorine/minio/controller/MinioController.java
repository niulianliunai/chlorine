...
//    }
    ...
    public CommonResult<String> uploadFile(@PathVariable String bucketName,@RequestParam("file") MultipartFile file, HttpServletRequest request) {
        return CommonResult.success(minioUtil.uploadFile(bucketName,file, request));
    }
